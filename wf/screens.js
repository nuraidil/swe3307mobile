...
function datePickerHTML(){
  ...
  const rangeStartKey = '2026-06-24'; // bookings open from this date onwards
  const rangeEndKey   = '2026-07-31'; // bookable window closes after this date
  ...
  const atMin = (y===2026 && m===5);
  const atMax = (y===2026 && m===6);
      ...
      <div class="p3grid">
        <div class="col gap16">
          <div class="uicard">
            ...
            <div style="padding:0 18px 16px;" class="col gap6">
              <span class="t12 b6 muted">Expected number of attendees</span>
              <input type="number" class="field" data-input="p3pax" min="1" max="${room.cap}" placeholder="e.g. 25" value="${s.pax}" style="max-width:160px;" />
              ${s.paxError ? `<span class="t11" style="color:var(--error-deep);">${s.paxError}</span>` : `<span class="t11 muted">Must not exceed room capacity of ${room.cap} pax.</span>`}
            </div>
          </div>
          <div class="uicard">
