  ...
  return shell("app / dashboard", 'dashboard', `
    ...
    <div class="scrollpad">
      ...
      <div class="dash-bottom">
        ...
        <div class="uicard" style="background:linear-gradient(135deg, var(--secondary), var(--secondary-deep));border:0;display:flex;flex-direction:column;justify-content:space-between;padding:24px;">
          <div class="col gap8">
            <span class="label-kicker" style="color:#aebfd0;">Quick Access</span>
            <span class="b8 t18 disp" style="color:#fff;">Need a room right now?</span>
            <span class="t13" style="color:#cfdbe8;">Our smart engine matches you to the best available space in seconds.</span>
          </div>
        ...
        <div class="col gap16">
          <div class="uicard">
            ...
            <div class="row gap14" style="padding:16px 18px;flex-wrap:wrap;">
              <div class="ph" style="width:52px;height:52px;flex-shrink:0;background:var(--primary);color:#fff;border:0;">⌂</div>
