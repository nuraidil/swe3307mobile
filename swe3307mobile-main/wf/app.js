...
const WF = {
  ...
  p3: { addons: {}, day: 'Mon', start: '09:00', end: '11:00', email: true, conflictError: null },
...
function createBooking(data){
  ...
  WF.session.bookings.push({ id, status:'pending', state:'pending', reported:false, occu:'unchecked', occuDeadline:null, ...data });
